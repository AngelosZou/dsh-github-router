 ...
 * `@deepseek-ai/dsh-client-store` (the shared browser snapshot-store seed —
 * the only runtime API it uses is `createSnapshotStore`). All copy goes
 * through the framework locale service under the `dsh-github-router`
 * namespace.
 */
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var runtime = require('@deepseek-ai/dsh-client-store');
